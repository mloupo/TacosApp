...
{
    class AddPurchasePricePurchaseDetail : AbstractValidator<CreatePurchaseDetailDTO>
    {
        public AddPurchasePricePurchaseDetail()
        {
            RuleFor(u => u.PurchasePrice).Cascade(CascadeMode.Stop)
